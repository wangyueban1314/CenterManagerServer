...
internal class Class33_R {
	...
	public List<Class34> list_0 = new List<Class34>();
	...
	protected virtual Enum2 vmethod_5(IntPtr intptr_0, Enum3 enum3_0, int int_0) {
		try {
			lock (object_0) {
				var class34_ = new Class34();
				if (!method_18(intptr_0, ref class34_, bool_0: false)) {
					return Enum2.const_2;
				}
				if (class34_.uint_0 == 0) {
					class34_.uint_0 = 1u;
					if (!method_17(intptr_0, class34_, bool_0: false)) {
						return Enum2.const_2;
					}
					class46_0.method_40(class34_.intptr_0);
				}
				else if (class34_.uint_0 == 2) {
	...
	protected virtual Enum2 vmethod_10(Class46 class46_1, IntPtr intptr_0, byte[] byte_0) {
		try {
			var class34_ = new Class34();
			if (!method_15(intptr_0, ref class34_, bool_0: true)) {
				return Enum2.const_2;
			}
			byte[] byte_ = new byte[0];
			switch (method_10(intptr_0, byte_0, out byte_)) {
				case 0:
					if (!class48_0.method_29(class34_.intptr_1, byte_0, byte_0.Length)) {
						return Enum2.const_2;
					}
					break;
				case 2:
					if (!class48_0.method_29(class34_.intptr_1, byte_, byte_.Length)) {
						return Enum2.const_2;
					}
					break;
			}
	...
	protected virtual Enum2 vmethod_11(Class46 class46_1, IntPtr intptr_0, Enum3 enum3_0, int int_0) {
		try {
			lock (object_0) {
				var class34_ = new Class34();
				if (!method_18(intptr_0, ref class34_, bool_0: true)) {
					return Enum2.const_2;
				}
				if (class34_.uint_0 == 0) {
					class34_.uint_0 = 2u;
					if (!method_17(intptr_0, class34_, bool_0: true)) {
						return Enum2.const_2;
					}
					class48_0.method_39(class34_.intptr_1);
				}
				else if (class34_.uint_0 == 1) {
	...
	private bool method_14(IntPtr intptr_0, Class34 class34_0, bool bool_0)
	{
		try
		{
			lock (object_0)
	...
	private bool method_15(IntPtr intptr_0, ref Class34 class34_0, bool bool_0)
	{
		try
		{
			lock (object_0)
	...
	protected virtual Enum2 vmethod_4(IntPtr intptr_0, byte[] byte_0)
	{
		...
		{
			var class34_ = new Class34();
			if (!method_15(intptr_0, ref class34_, bool_0: false))
			{
				return Enum2.const_2;
			}
			byte[] byte_ = new byte[0];
			switch (method_9(intptr_0, class34_, byte_0, out byte_))
			{
				case 0:
					if (!class46_0.method_30(class34_.intptr_0, byte_0, byte_0.Length))
					{
						return Enum2.const_2;
					}
					break;
				case 2:
					if (!class46_0.method_30(class34_.intptr_0, byte_, byte_.Length))
					{
						return Enum2.const_2;
					}
					break;
	...
	public bool method_11(IntPtr intptr_0, Class34 class34_0, byte[] byte_0) {
		try {
			class34_0.byte_1 = byte_0;
			if (method_14(intptr_0, class34_0, bool_0: true)) {
				return true;
			}
			return false;
		}
	...
	private bool method_12(IntPtr intptr_0, Class34 class34_0) {
		try {
			lock (object_0) {
	...
	protected virtual Enum2 vmethod_8(Class46 class46_1, IntPtr intptr_0, IntPtr intptr_1)
	{
		try
		{
			...
			ushort num = 0;
			if (!class46_0.method_47(intptr_0, ref string_, ref num))
			{
				return Enum2.const_2;
			}
			...
			if (!Class0.smethod_1(num, out int int_, out string text))
			{
				return Enum2.const_2;
			}
	...
	private bool method_17(IntPtr intptr_0, Class34 class34_0, bool bool_0)
	{
		try
		{
			if (list_0.Count > 0)
	...
	public int method_9(IntPtr intptr_0, Class34 class34_0, byte[] byte_0, out byte[] byte_1)
	{
		byte_1 = byte_0;
		if ((ushort)BitConverter.ToInt16(byte_0, 2) == 20480 && class34_0.string_0.IndexOf("AgentServe") > -1)
		{
			string text = Class1.smethod_3(class34_0.int_0);
			if (text == "")
			{
				MessageBox.Show("启动 AgentServer 失败！");
				Class6.smethod_8();
				return 1;
			}
			text += "server.cfg";
			if (!File.Exists(text))
			{
				MessageBox.Show("启动 AgentServer 失败,找不到server.cfg文件！");
				Class6.smethod_8();
				return 1;
			}
			if (Class9.smethod_8(text, "GatewayServer") != Class8.ushort_6)
			{
				MessageBox.Show("server.cfg 文件内的GatewayServer2 -> Certification 项未将端口设置为 35880，请手动设置该选项后再进行启动！", "", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				Class6.smethod_8();
				return 1;
			}
			...
			if (Class8.int_28 == 0)
			{
				int_ = ((!Class8.bool_64) ? Class15.Get_AgentIp() : (11));
			}
			...
			if (num < 1)
			{
				MessageBox.Show("读取AgentServer信息失败 001！");
				Class6.smethod_8();
				return 1;
			}
			string text2 = Class1.smethod_7(num);
			if (Class8.bool_64 && text2.ToUpper() == "D191934F163D3706C79D69B281028836")
			{
				MessageBox.Show("请使用R版本AgentServer！");
				Class6.smethod_8();
				return 0;
			}
			if (text2.ToUpper() != "D191934F163D3706C79D69B281028836")
			{
				num2 = Class1.OpenProcess(2035711, bool_0: false, num);
				if (num2 < 1)
				{
					MessageBox.Show("读取AgentServer信息失败 002！");
					Class6.smethod_8();
					return 1;
				}
				if (!Class1.ReadProcessMemory(num2, 0X48A042, array, 6, out int_2))
				{
					Class1.CloseHandle(num2);
					MessageBox.Show("读取AgentServer信息失败 003！");
					Class6.smethod_8();
					return 1;
				}
				...
				{
					Class1.CloseHandle(num2);
					MessageBox.Show("读取AgentServer信息失败 004！");
					Class6.smethod_8();
					return 1;
				}
				if (Class1.WriteProcessMemory(num2, 0X48A042, new byte[6] { 185, 255, 255, 255, 127, 144 }, 6, 0) == 0)
				{
					Class1.CloseHandle(num2);
					MessageBox.Show("读取AgentServer信息失败 005！");
					Class6.smethod_8();
					return 1;
				}
				if (!Class1.CloseHandle(num2))
				{
					MessageBox.Show("读取AgentServer信息失败 006！");
					Class6.smethod_8();
					return 1;
				}
				if (array.Length != 0 && array[0] != 185)
				{
					Class6.smethod_0(2, "System AgentServer 连接完成", 0);
				}
			}
		}
		int num3 = 0;
		int num4 = -1;
		if (class34_0.string_0.IndexOf("AgentServe") > -1)
		{
			num4 = Class1.smethod_10(byte_1, BitConverter.GetBytes(Class8.ushort_1));
			if (num4 > -1)
			{
				Array.Copy(BitConverter.GetBytes(Class8.ushort_5), 0, byte_1, num4, 2);
				num3++;
			}
		}
		if (num3 > 0)
	...
	private bool method_18(IntPtr intptr_0, ref Class34 class34_0, bool bool_0) {
		try {
			class34_0 = new Class34();
			if (list_0.Count > 0) {
				int num = 0;
