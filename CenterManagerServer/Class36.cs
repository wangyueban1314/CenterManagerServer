	...
	public int method_9(IntPtr intptr_0, Class37 class37_0, byte[] byte_0, out byte[] byte_1)
	{
		...
		if ((ushort)BitConverter.ToInt16(byte_0, 2) == 20480)
		{
			if (class37_0.string_0.IndexOf("GatewayServe") > -1)
			{
				...
				{
					MessageBox.Show("server.cfg 文件内的GatewayServer3 -> Certification 项未将端口设置为 35880，请手动设置该选项后再进行启动！", "", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
					Class6.smethod_8();
					return 1;
				}
				...
				if (!Class1.ReadProcessMemory(num2, 0X49A412, array, 6, out int int_2))
				{
				...
				if (Class1.WriteProcessMemory(num2, 0X49A412, new byte[6] { 185, 255, 255, 255, 127, 144 }, 6, 0) == 0)
				{
					Class1.CloseHandle(num2);
			...
			else if (class37_0.string_0.IndexOf("DownloadServe") > -1 && Class8.bool_57)
			{
				...
				{
					MessageBox.Show("server.cfg 文件内的GatewayServer4 -> Certification 项未将端口设置为 35880，请手动设置该选项后再进行启动！", "", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
					Class6.smethod_8();
					return 1;
				}
				...
				if (!Class1.ReadProcessMemory(num4, 0X47E092, array2, 6, out int int_4))
				{
				...
				if (Class1.WriteProcessMemory(num4, 0X47E092, new byte[6] { 185, 255, 255, 255, 127, 144 }, 6, 0) == 0)
				{
					Class1.CloseHandle(num4);
