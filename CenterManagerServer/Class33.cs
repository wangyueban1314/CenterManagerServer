	...
	public int method_9(IntPtr intptr_0, Class34 class34_0, byte[] byte_0, out byte[] byte_1) {
		...
		if ((ushort)BitConverter.ToInt16(byte_0, 2) == 20480 && class34_0.string_0.IndexOf("AgentServe") > -1) {
			...
			if (Class9.smethod_8(text, "GatewayServer") != Class8.ushort_6) {
				MessageBox.Show("server.cfg 文件内的GatewayServer1 -> Certification 项未将端口设置为 35880，请手动设置该选项后再进行启动！", "", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				Class6.smethod_8();
				return 1;
			}
			...
			if (text2.ToUpper() != "D191934F163D3706C79D69B281028836") {
				...
				if (!Class1.ReadProcessMemory(num2, 0X489C82, array, 6, out int_2)) {
				...
				if (Class1.WriteProcessMemory(num2, 0X489C82, new byte[6] { 185, 255, 255, 255, 127, 144 }, 6, 0) == 0) {
					Class1.CloseHandle(num2);
