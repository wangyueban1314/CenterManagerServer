...
internal class Class28 {
    ...
    public static byte[] smethod_0(byte[] byte_0, string string_0) {
        if (byte_0 != null && string_0 != null) {
            ...
            long num = 0L;
            long num2 = 0L;
            byte[] array3 = smethod_4(Encoding.Default.GetBytes(string_0), 192);
            for (long num3 = 0L; num3 < array.Length; num3++) {
                num = (num + 1L) % array3.Length;
                num2 = (num2 + array3[num]) % array3.Length;
                byte b = array3[num];
                array3[num] = array3[num2];
                array3[num2] = b;
                byte b2 = array[num3];
                byte b3 = array3[(array3[num] + array3[num2]) % array3.Length];
                array2[num3] = (byte)(b2 ^ b3);
            }
            byte[] array4 = new byte[byte_0.Length];
            Array.Copy(byte_0, 0, array4, 0, 4);
    ...
    private static byte[] smethod_4(byte[] byte_0, int int_0) {
        byte[] array = new byte[int_0];
        for (long num = 0L; num < int_0; num++) {
            array[num] = (byte)num;
        }
        long num2 = 0L;
        for (long num3 = 0L; num3 < int_0; num3++) {
            num2 = (num2 + array[num3] + byte_0[num3 % byte_0.Length]) % int_0;
            byte b = array[num3];
    ...
    public static byte[] smethod_1(byte[] byte_0, string string_0)
    {
        try
        {
            if (byte_0 != null && string_0 != null)
            {
                ...
                byte[] array2 = smethod_4(Encoding.Default.GetBytes(string_0), Class15.int_1);
                for (long num3 = 0L; num3 < byte_0.Length; num3++)
                {
                    num = (num + 1L) % array2.Length;
                    num2 = (num2 + array2[num]) % array2.Length;
                    byte b = array2[num];
                    array2[num] = array2[num2];
                    array2[num2] = b;
                    byte b2 = byte_0[num3];
                    byte b3 = array2[(array2[num] + array2[num2]) % array2.Length];
                    array[num3] = (byte)(b2 ^ b3);
                }
                return array;
            }
            return null;
    ...
    public static byte[] smethod_2(byte[] byte_0, string string_0)
    {
        try
        {
            if (byte_0 != null && string_0 != null)
            {
                ...
                long num = 0L;
                long num2 = 0L;
                byte[] array2 = smethod_4(Encoding.Default.GetBytes(string_0), 256);
                for (long num3 = 0L; num3 < byte_0.Length; num3++)
                {
                    num = (num + 1L) % array2.Length;
                    num2 = (num2 + array2[num]) % array2.Length;
    ...
    public static uint smethod_5(byte[] byte_0) {
        uint num = (uint)byte_0.Length;
        uint num2 = uint.MaxValue;
        for (uint num3 = 0u; num3 < num; num3++) {
            num2 = (num2 << 8) ^ uint_0[(num2 >> 24) ^ byte_0[num3]];
        }
        return num2;
    }
}
